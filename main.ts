...
namespace guitarchord {
    ...
    //% blockId=multitone_play_chord block="和音 %chord を鳴らす"
    //% group="和音" weight=90
    //% chord.defl=Chord.C
     ...
     */
    //% blockId=multitone_assign_chord block="%button に和音 %chord を割り当てる"
